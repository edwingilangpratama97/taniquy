...
<div class="row match-height">
    ...
    <div class="col-md-6 col-12">
        <div class="card">
            ...
            <div class="card-content">
            <div class="card-body">
                <form class="form form-vertical" action="{{route('retailer.update',$data->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-body">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input type="text" id="nama-vertical" class="form-control @error('nama') is-invalid @enderror" name="nama"
                                placeholder="Nama Kelompok" value="{{$data->nama}}">
                        ...
                        <div class="col-6">
                                ...
                                <select name="jenis_usaha" id="" class="form-control">
                                    <option value="{{$data->jenis_usaha}}" {{$data->jenis_usaha == 'Perorangan' ? 'selected' : false}}>Perorangan</option>
                                    <option value="{{$data->jenis_usaha}}" {{$data->jenis_usaha == 'PT' ? 'selected' : false}}>PT</option>
                                    <option value="{{$data->jenis_usaha}}" {{$data->jenis_usaha == 'CV' ? 'selected' : false}}>CV</option>
                                </select>
                                @error('jenis_usaha')
                                <div class="invalid-feedback">
                                    <i class="bx bx-radio-circle"></i>
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" id="kontak-vertical" class="form-control @error('kontak') is-invalid @enderror" name="kontak"
                                placeholder="Kontak" value="{{$data->kontak}}">
                            @error('kontak')
                            <div class="invalid-feedback">
                                <i class="bx bx-radio-circle"></i>
                                {{{$message}}}
