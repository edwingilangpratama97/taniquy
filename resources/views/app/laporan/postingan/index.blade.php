...
<div class="page-title">
    ...
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            <h3>Laporan Postingan</h3>
            <p class="text-subtitle text-muted">Laporan Untuk Data Postingan</p>
        </div>
...
<div class="row match-height">
    <div class="col-md-12 col-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="form form-vertical" action="{{route('laporan.postingan.pdf')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                <div class="form-body">
                    <div class="row">
                        <div class="col-6">
