        ...
        <div class="row match-height">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input type="text" id="latitude-view" class="form-control @error('latitude') is-invalid @enderror" value="{{$retailer->latitude}}"  readonly>
                                @error('latitude')
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" id="longitude-view" class="form-control @error('longitude') is-invalid @enderror"  value="{{$retailer->longitude}}" readonly>
                                @error('longitude')
                                <div class="invalid-feedback">
                                    <i class="bx bx-radio-circle"></i>
                                    {{{$message}}}
            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                    <form class="form form-vertical" action="{{route('updateAccountRetailer',$data->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <input id="latitude" type="hidden" name="latitude"  value="{{$retailer->latitude}}"/>
                        <input id="longitude" type="hidden" name="longitude"  value="{{$retailer->longitude}}"/>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" id="nama-vertical" class="form-control @error('nama') is-invalid @enderror" name="nama"
                                        placeholder="Nama Kelompok" value="{{$retailer->nama}}">
                                ...
                                <div class="col-6">
                                        ...
                                        <select name="jenis_usaha" id="" class="form-control">
                                            <option value="{{$retailer->jenis_usaha}}" {{$retailer->jenis_usaha == 'Perorangan' ? 'selected' : false}}>Perorangan</option>
                                            <option value="{{$retailer->jenis_usaha}}" {{$retailer->jenis_usaha == 'PT' ? 'selected' : false}}>PT</option>
                                            <option value="{{$retailer->jenis_usaha}}" {{$retailer->jenis_usaha == 'CV' ? 'selected' : false}}>CV</option>
                                        </select>
                                        @error('jenis_usaha')
                                        <div class="invalid-feedback">
                                            <i class="bx bx-radio-circle"></i>
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" id="kontak-vertical" class="form-control @error('kontak') is-invalid @enderror" name="kontak"
                                        placeholder="Kontak" value="{{$retailer->kontak}}">
                                    @error('kontak')
                                    <div class="invalid-feedback">
                                        <i class="bx bx-radio-circle"></i>
                                        {{{$message}}}
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('alamat') is-invalid @enderror" name="alamat" id="alamat" rows="3"> {{$retailer->alamat}}</textarea>
                                        @error('alamat')
                                        <div class="invalid-feedback">
                                            <i class="bx bx-radio-circle"></i>
                                            {{{$message}}}
...
<script type="text/javascript">
    ...
    var latitudeNow = {{$retailer->latitude}};
    var longitudeNow = {{$retailer->longitude}}
