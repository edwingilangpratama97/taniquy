...
<div class="row match-height">
    ...
    <div class="col-md-6 col-12">
        <div class="card">
            ...
            <div class="card-content">
            <div class="card-body">
                <form class="form form-vertical" action="{{route('kelompok.update',$data->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" id="ketua-vertical" class="form-control @error('ketua') is-invalid @enderror" name="ketua" placeholder="Nama Ketua" value="{{$data->ketua}}">
                            @error('ketua')
                            <div class="invalid-feedback">
                                <i class="bx bx-radio-circle"></i>
                                {{{$message}}}
