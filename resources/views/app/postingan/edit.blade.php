...
<div class="row match-height">
    <div class="col-md-6 col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form form-vertical" action="{{route('postingan.update',$data->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-body">
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <label for="mangga-select">Kode Postingan</label>
                                <input class="form-control" type="text" name="kode_postingan" value="{{$data->kode_postingan}}" readonly>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <select class="form-select @error('id_mangga') is-invalid @enderror" id="mangga-select" name="id_mangga">
                                    <option value="{{$data->id_mangga}}">-- Pilih Disini --</option>
                                    @foreach($mangga as $p)
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('keterangan') is-invalid @enderror" name="keterangan" id="keterangan" rows="5">{{$data->keterangan}}</textarea>
                                @error('keterangan')
                                <div class="invalid-feedback">
                                    <i class="bx bx-radio-circle"></i>
                                    {{{$message}}}
