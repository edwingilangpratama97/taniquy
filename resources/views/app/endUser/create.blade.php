...
<div class="row match-height">
    ...
    <div class="col-md-6 col-12">
        <div class="card">
            ...
            <div class="card-content">
            <div class="card-body">
                <form class="form form-vertical" action="{{route('customer.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="form-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <input type="date" id="tgl_lahir-vertical" class="form-control @error('tgl_lahir') is-invalid @enderror" name="tgl_lahir">
                            @error('tgl_lahir')
                            <div class="invalid-feedback">
                                <i class="bx bx-radio-circle"></i>
                                {{{$message}}}
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select class="form-select @error('jenis_kelamin') is-invalid @enderror" id="jenis_kelamin-select" name="jenis_kelamin">
