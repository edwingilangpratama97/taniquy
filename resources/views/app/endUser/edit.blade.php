...
<div class="row mb-2">
    ...
    <div class="col-5 col-md-6">
        <span class="float-right">
            <a href="{{route('customer.index')}}" class="btn btn-sm icon btn-warning p-2"><i data-feather="arrow-left" class="mr-2"></i>Kembali</a>
        </span>
    </div>
</div>
<div class="row match-height">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <input type="text" id="latitude-view" class="form-control @error('latitude') is-invalid @enderror" value="{{$data->latitude}}" readonly>
                        @error('latitude')
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" id="longitude-view" class="form-control @error('longitude') is-invalid @enderror" value="{{$data->longitude}}" readonly>
                        @error('longitude')
                        <div class="invalid-feedback">
                            <i class="bx bx-radio-circle"></i>
                            {{{$message}}}
    ...
    <div class="col-md-6 col-12">
        <div class="card">
            ...
            <div class="card-content">
            <div class="card-body">
                <form class="form form-vertical" action="{{route('customer.update',$data->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-body">
                    <input id="latitude" type="hidden" name="latitude" value="{{$data->latitude}}" />
                    <input id="longitude" type="hidden" name="longitude" value="{{$data->longitude}}" />
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                            <label for="nama-vertical">Nama</label>
                            <input type="text" id="nama-vertical" class="form-control @error('nama') is-invalid @enderror" name="nama" placeholder="Nama" value="{{$data->nama}}">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" id="kontak-vertical" class="form-control @error('kontak') is-invalid @enderror" name="kontak" placeholder="Kontak" value="{{$data->kontak}}">
                            @error('kontak')
                            <div class="invalid-feedback">
                                <i class="bx bx-radio-circle"></i>
                                {{{$message}}}
                        ...
                        <div class="col-6">
                            <div class="form-group">
                            <label for="tgl_lahir-vertical">Tanggal Lahir</label>
                            <input type="date" id="tgl_lahir-vertical" class="form-control @error('tgl_lahir') is-invalid @enderror" name="tgl_lahir" value="{{$data->tgl_lahir}}">
                            @error('tgl_lahir')
                            <div class="invalid-feedback">
                                <i class="bx bx-radio-circle"></i>
                                {{{$message}}}
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select class="form-select @error('jenis_kelamin') is-invalid @enderror" id="jenis_kelamin-select" name="jenis_kelamin" value="{{$data->jenis_kelamin}}">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('alamat') is-invalid @enderror" name="alamat" id="alamat" rows="3">{{$data->alamat}}</textarea>
                                @error('alamat')
                                <div class="invalid-feedback">
                                    <i class="bx bx-radio-circle"></i>
                                    {{{$message}}}
...
<script type="text/javascript">
    ...
    var latitudeNow = {{$data->latitude}};
    var longitudeNow = {{$data->longitude}}
